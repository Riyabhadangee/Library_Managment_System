  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black flex items-center justify-center py-12 px-4">
      <div className="max-w-md w-full">
        ...
        {/* Card */}
        <div className="bg-gray-900/80 backdrop-blur-xl border border-gray-700 rounded-2xl shadow-xl p-8">
          ...
          {forgotPasswordSuccess ? (
            <Box className="text-center space-y-6">
              ...
              <div>
                ...
                {/* Email Box */}
                <div className="bg-gray-800 px-4 py-2 rounded-lg inline-block font-semibold text-gray-200 mb-4 border border-gray-700">
                  {email}
                </div>
            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {/* Back */}
                <div className="text-center">
                  <Link to="/login" className="text-teal-400 text-sm hover:text-teal-300">
                    ← Back to Login
                  </Link>
                </div>
