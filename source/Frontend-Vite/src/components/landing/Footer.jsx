...
//   const contactInfo = [
//     { icon: EmailIcon, text: 'contact@smartliblibrary.com' },
...
//               © {currentYear} SmartLib Library. All rights reserved.
//             </p>
...
//               Made with <span className="text-red-500">❤</span> by SmartLib Team
//             </p>
//           </div>
//         </div>
//       </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-3">
              {contactInfo.map((item, index) => {
                ...
                return (
                  <div key={index} className="flex items-center space-x-3 text-sm">
                    <Icon sx={{ fontSize: 16, color: '#2dd4bf' }} />
                    <span>{item.text}</span>
                  </div>
                );
              })}
          ...
          {Object.entries(footerLinks).map(([key, links]) => (
            <div key={key}>
              <h3 className="text-white font-semibold mb-4 capitalize">{key}</h3>
              <ul className="space-y-3">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex w-full md:w-auto gap-2">
              <input
                type="email"
                placeholder="Enter your email"
                className="px-4 py-3 bg-gray-900 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 text-white placeholder-gray-500 flex-1 md:w-64"
              />
              <button className="px-6 py-3 bg-gradient-to-r from-teal-500 to-cyan-500 text-white font-semibold rounded-lg hover:opacity-90 transition">
                Subscribe
              </button>
            </div>
