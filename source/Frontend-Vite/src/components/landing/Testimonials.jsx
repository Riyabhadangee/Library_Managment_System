...
//                 <FormatQuoteIcon sx={{ fontSize: 64, color: '#004844' }} />
//               </div>
  ...
  return (
    <section className="py-20 bg-gray-950 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              <div className="absolute top-6 right-6 opacity-10 group-hover:opacity-20 transition">
                <FormatQuoteIcon sx={{ fontSize: 64, color: '#2dd4bf' }} />
              </div>
              ...
              {/* USER */}
              <div className="flex items-center space-x-4">
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-teal-400 to-cyan-500 flex items-center justify-center text-2xl shadow-md">
                  {testimonial.image}
                </div>
                <div>
        ...
        {/* CTA */}
        <div className="mt-16 text-center bg-gray-900/60 backdrop-blur-xl border border-gray-800 rounded-3xl p-12 shadow-lg">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button className="px-8 py-4 bg-gradient-to-r from-teal-500 to-cyan-500 text-white font-semibold rounded-xl hover:opacity-90 transition shadow-lg hover:shadow-teal-500/20">
              Start Free Trial
            </button>

            <button className="px-8 py-4 border border-teal-400 text-teal-300 font-semibold rounded-xl hover:bg-teal-500/10 transition">
              View Membership Plans
            </button>
