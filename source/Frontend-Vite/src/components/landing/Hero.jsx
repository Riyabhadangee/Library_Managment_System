...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-black overflow-hidden text-white">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left animate-fade-in-up">
            ...
            {/* Badge */}
            <div className="inline-flex items-center space-x-2 bg-teal-500/10 text-teal-400 border border-teal-400/20 px-4 py-2 rounded-full text-sm font-medium mb-6">
              <AutoAwesomeIcon sx={{ fontSize: 16 }} />
              <span>Welcome to SmartLib Library</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <Link
                to="/books"
                className="group inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-teal-500 to-cyan-500 text-white font-semibold rounded-xl shadow-[0_0_20px_rgba(45,212,191,0.5)] hover:from-teal-400 hover:to-cyan-400 transition-all duration-200 transform hover:-translate-y-0.5"
              >
                <span>Explore Books</span>
                <ArrowForwardIcon className="ml-2 group-hover:translate-x-1 transition-transform" sx={{ fontSize: 20 }} />
              </Link>
              ...
              <Link
                to="/login"
                className="inline-flex items-center justify-center px-8 py-4 bg-transparent text-teal-400 font-semibold rounded-xl border border-teal-400 hover:bg-teal-500/10 transition-all duration-200"
              >
                <MenuBookIcon className="mr-2" sx={{ fontSize: 20 }} />
                <span>Login</span>
              </Link>
            ...
            {/* Stats */}
            <div className="mt-12 flex flex-wrap items-center justify-center lg:justify-start gap-8 text-sm text-gray-400">
              <div className="flex items-center space-x-2">
          ...
          <div className="relative hidden lg:block">
            <div className="relative">
              ...
              {/* Decorative */}
              <div className="absolute -top-4 -left-4 w-72 h-72 bg-teal-500/20 rounded-3xl transform rotate-6"></div>
              <div className="absolute -bottom-4 -right-4 w-72 h-72 bg-cyan-500/20 rounded-3xl transform -rotate-6"></div>

              {/* Card */}
              <div className="relative bg-gray-900/80 backdrop-blur-xl border border-gray-700 rounded-3xl shadow-2xl p-8 transition-transform duration-300 hover:scale-105">
                
                <div className="space-y-4">

                  {/* Books */}
                  <div className="flex justify-center items-end space-x-2 h-64">
                    <div className="w-16 h-48 bg-gradient-to-br from-teal-400 to-teal-600 rounded-lg shadow-lg hover:-translate-y-2 transition-transform"></div>
                    <div className="w-16 h-56 bg-gradient-to-br from-cyan-400 to-cyan-600 rounded-lg shadow-lg hover:-translate-y-2 transition-transform"></div>
                    <div className="w-16 h-40 bg-gradient-to-br from-violet-400 to-violet-600 rounded-lg shadow-lg hover:-translate-y-2 transition-transform"></div>
                    <div className="w-16 h-52 bg-gradient-to-br from-blue-400 to-blue-600 rounded-lg shadow-lg hover:-translate-y-2 transition-transform"></div>
                  </div>

                  {/* Badge */}
                  <div className="absolute top-4 right-4 bg-yellow-400/10 text-yellow-300 px-4 py-2 rounded-full text-sm font-semibold shadow-lg animate-bounce">
                    📚 New Arrivals
                  </div>
